...
mod tests {
    ...
    // Test works, except user already exists. Commented out until implement delete user.
    // #[tokio::test]
    ...
    // The test below has been tested and works, however it requires you to access the email and the values time out
    // There is no way I can think to test this
    // #[tokio::test]
